...
// import { CounterSelector } from '@/components/CounterSelector'; // Parece no usarse, lo comentamos por ahora
import { SignaturePad } from '@/components/SignatureCanvas';
import { formatCurrency, generateUniqueId, calculateCounterDifference, calculateRevenue } from '@/lib/utils';
import { Machine } from '@/lib/db'; // Importar el tipo Machine
...
export const CollectionForm = ({ onSuccess, onCancel }: CollectionFormProps) => {
  ...
  const [clientMachines, setClientMachines] = useState<Machine[]>([]); // Usar Machine[] en lugar de any[]
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 py-4">
      ...
      <div className="grid w-full gap-1.5">
        ...
        <select 
          id="client"
          title="Seleccionar cliente" // Añadido para accesibilidad
            ...
            {clientMachines.map(machine => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <input 
                    type="checkbox" 
                    title={`Seleccionar máquina ${machine.serialNumber}`} // Añadido para accesibilidad
        ...
        <div className="space-y-4 border-t pt-4 mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="grid w-full gap-1.5">
              ...
              <select 
                id="collectionMethod"
                title="Seleccionar método de recaudación" // Añadido para accesibilidad
